...
with col1:
    ...
    st.markdown("---")
with col2:
    st.image("WhatsApp Image 2026-06-16 at 1.25.23 PM.jpeg",width=300)
...
with tab3:
    ...
    st.image("python.jpeg",width=500)
    st.write("Introduction to ai")
    st.image("simp.jpeg",width=500)
    st.write("prompt engneering")
    st.image("prompt.jpeg",width=500)
